      ...
      const App = () => {
        ...
        return (
          <div>
            ...
            <button onClick={() => setUsersAction(initialState.users.map((u, index) => index === 0 ? { ...u } : u))}>setUser0</button>
            <button onClick={() => setUsersAction(initialState.users.map((u, index) => index === 1 ? { ...u } : u))}>setUser1</button>
            <button onClick={() => setUsersAction(initialState.users.map((u, index) => index === 2 ? { ...u } : u))}>setUser2</button>
          </div>
        );
      };
